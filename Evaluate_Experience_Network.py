...
class evaluate_net(nn.Module):
    def __init__(self,num_param,num_pos,num_evader,max_steps):
        super(evaluate_net, self).__init__()
    ...
    def forward(self,param,ego_pos,eva_pos,reward,action):
        ...
        # critic_param_feature = F.elu(self.fc_critic_param_1(critc_param))
        # critic_param_feature = F.elu(self.fc_critic_param_2(critic_param_feature))
        # critic_param_feature = F.elu(self.fc_critic_param_3(critic_param_feature))
